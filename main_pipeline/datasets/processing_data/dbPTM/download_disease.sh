#!/bin/bash
#
# Script to query disease labels from UniProt for dbPTM sequences.
# This script runs the query_disease_labels.py script with appropriate parameters.
#
...
echo "=========================================="
echo "🚀 Starting Disease Label Query"
echo "=========================================="
...
python query_disease_labels.py "$INPUT_FILE" "$OUTPUT_FILE" "$ACCESSION_COL"
